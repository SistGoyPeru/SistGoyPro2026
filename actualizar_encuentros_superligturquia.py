...
SOURCE_URL = "https://www.livefutbol.com/competition/co116/turquia-sueperlig/all-matches/"
BASE_URL = "https://www.livefutbol.com"
OUTPUT_FILE = Path(__file__).resolve().parent / "superlig_turquia_encuentros.csv"
FIELDNAMES = [
    "competicion",
    "jornada",
    "fecha",
