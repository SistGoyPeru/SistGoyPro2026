...
SOURCE_URL = "https://www.livefutbol.com/competition/co71/francia-ligue-1/all-matches/"
BASE_URL = "https://www.livefutbol.com"
OUTPUT_FILE = Path(__file__).resolve().parent / "ligue1_francia_encuentros.csv"
FIELDNAMES = [
    "competicion",
    "jornada",
    "fecha",
