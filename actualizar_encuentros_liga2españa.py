...
SOURCE_URL = "https://www.livefutbol.com/competition/co110/espana-segunda-division/all-matches/"
BASE_URL = "https://www.livefutbol.com"
OUTPUT_FILE = Path(__file__).resolve().parent / "liga2_españa_encuentros.csv"
FIELDNAMES = [
    "competicion",
    "jornada",
    "fecha",
...
def extract_matches(html: str) -> list[dict[str, str]]:
    ...
    for child in container.find_all(recursive=False):
        ...
        matches.append(
            {
                "competicion": "Segunda División España",
