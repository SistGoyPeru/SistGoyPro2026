...
SOURCE_URL = "https://www.livefutbol.com/competition/co49/belgica-pro-league/all-matches/"
BASE_URL = "https://www.livefutbol.com"
OUTPUT_FILE = Path(__file__).resolve().parent / "proleague_belgica_encuentros.csv"
FIELDNAMES = [
    "competicion",
    "jornada",
    "fecha",
...
def extract_matches(html: str) -> list[dict[str, str]]:
    ...
    for child in container.find_all(recursive=False):
        ...
        matches.append(
            {
                "competicion": "Pro League Bélgica",
