...
SOURCE_URL = "https://www.football-data.co.uk/mmz4281/2526/SC0.csv"
OUTPUT_FILE = Path(__file__).resolve().parent / "premierleague_escocia.csv"
...
def normalize_rows(rows: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    for row in rows:
        ...
        if row.get("Div") == "SC0":
            normalized_row["Div"] = "Premiership Escocia"
