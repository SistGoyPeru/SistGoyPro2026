...
from .views import best_bets_1x2_pdf, best_bets_by_date, best_bets_double_chance_pdf, best_bets_totals_pdf, best_bets_summary_pdf, dashboard, best_bets_pdf, league_dashboard, match_prediction_page, refresh_all_leagues
...
urlpatterns = [
    ...
    path("mejores-apuestas/pdf-resumen-general/", best_bets_summary_pdf, name="best_bets_summary_pdf"),
