...
SOURCE_URL = "https://www.football-data.co.uk/mmz4281/2526/G1.csv"
OUTPUT_FILE = Path(__file__).resolve().parent / "superleague_grecia.csv"
...
def normalize_rows(rows: list[dict[str, str]]) -> list[dict[str, str]]:
    ...
    for row in rows:
        ...
        if row.get("Div") == "G1":
            normalized_row["Div"] = "Super League"
